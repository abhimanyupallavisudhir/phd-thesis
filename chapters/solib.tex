...
\chaptersource{\draft{This chapter is based on the paper ``A Benchmark for Scalable Oversight Mechanisms'', joint work with Jackson Kaunismaa (MATS) and Arjun Panickssery (ZemblaAI).}}
...
Below are simplified pseudo-Python descriptions of our protocols. For the exact implementations, see the relevant file in our code, e.g. \url{https://anonymous.4open.science/r/math_problems_debate-F4B4/solib/protocols/protocols/Debate.py}
