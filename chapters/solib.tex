...
\draft{\chaptersource{This chapter is based on the paper ``A Benchmark for Scalable Oversight Mechanisms'', joint work with Jackson Kaunismaa (MATS) and Arjun Panickssery (ZemblaAI).}}
